...
<asp:Content ID="Content2" ContentPlaceHolderID="mainContentPlaceHolder" runat="server">
    ...
    <div class="searchbox">
        <div class="searchcont">
            <asp:Button CssClass="icon" runat="server" ID="btnSearch" Text="Search" OnClick="btnSearch_Click" />
            <asp:TextBox CssClass="box" ID="tbSearch" runat="server"></asp:TextBox>
        </div>
    </div>
    ...
    <div id="container_home" class="grid_12">
        ...
        <section class="contents-showcase grid_12">
            <asp:Repeater ID="rptrDisplay" runat="server" DataSourceID="featuredsds">
                <HeaderTemplate>
                    <h2 class="welcome-head-section">
                        <img src="Images/SALEBANNER.png" width="200" height="47" alt="" /></h2>
                    <ul>
                </HeaderTemplate>
                <ItemTemplate>
                    <li class="product-display">
                        ...
                        <p class="sale-displaybody">BND&#36; <%#Eval("Price") %></p>
                    </li>
                </ItemTemplate>
                <FooterTemplate></ul></FooterTemplate>
            </asp:Repeater>

            <asp:SqlDataSource ID="featuredsds" runat="server" ConnectionString="<%$ ConnectionStrings:qiwebcon %>" SelectCommand="SELECT tbl_products.ProductId, tbl_products.IsOnSale, tbl_products.ImageId, tbl_products.Condition, tb_images.Extension, tb_images.AltText, tbl_products.ProductName, tbl_products.ProductDesc, tbl_products.StockQty, tbl_products.Price, tb_categories.CategoryName
FROM tbl_products
INNER JOIN tb_images 
ON tbl_products.ImageId = tb_images.ImageId 
INNER JOIN tb_categories 
ON tbl_products.CategoryId = tb_categories.CategoryId 
WHERE IsOnSale = 1"></asp:SqlDataSource>
